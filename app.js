...
Object.assign(copy.zh, {
  ...
  startFree: "免費產生第一份月報",
  viewSample: "查看範例月報",
  heroEyebrow: "給小型代理商與接案者的 AI 月報工具",
  heroCopy: "上傳 CSV、貼上 Google Sheets 或直接描述客戶需求，AgencyReport AI 會整理 KPI、圖表、洞察、下月行動與可交付 PDF。",
  ...
  salesFooterTitle: "Virtual Trend Works",
  salesFooterCopy: "AgencyReport AI 銷售、付款與客服聯絡資訊。",
...
Object.assign(copy.en, {
  ...
  viewSample: "View sample report",
  heroEyebrow: "AI monthly reports for small agencies and freelancers",
  heroCopy: "Upload CSV, paste a Google Sheets link, or describe the client brief. AgencyReport AI turns it into KPI, charts, insights, next actions, and a deliverable PDF.",
...
function applyLanguage(lang = state.lang) {
  ...
  if (heroTitle) {
    heroTitle.innerHTML = state.lang === "en"
      ? 'Stop writing reports.<br /><span class="title-accent">Send them instead.</span>'
      : '<span class="title-line">別再手動整理月報，</span><span class="title-line title-accent">讓 AI 產生可交付報告。</span>';
  }
